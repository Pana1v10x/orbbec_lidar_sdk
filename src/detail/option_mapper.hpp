...
class LidarOptionMapper {
   ...
   private:
    ...
    initializeCommandMap() {
        ...
        map.emplace(OB_LIDAR_OPTION_APD_TEMPERATURE,
                    std::make_pair(LidarCommandInterface::UNKNOWN,
                                   LidarCommandInterface::GET_APD_TEMPERATURE));
      map.emplace(OB_LIDAR_OPTION_SPECIAL_MODE,
                    std::make_pair(LidarCommandInterface::SET_SPECIAL_MODE,
                                   LidarCommandInterface::GET_SPECIAL_MODE));
